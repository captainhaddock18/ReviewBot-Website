...
const ProgressBar = ({ progress, duration = 27 }) => (
  <div className="relative mb-5 w-full max-w-[800px] mx-auto">
    <div className="relative rounded-full border-2 border-red-500 p-1 overflow-hidden">
      ...
      >
        ...
        <motion.div
          className="absolute top-0 left-0 w-[200%] h-full bg-[linear-gradient(45deg,rgb(255,255,255,0.2)_25%,transparent_25%,transparent_50%,rgb(255,255,255,0.2)_50%,rgb(255,255,255,0.2)_75%,transparent_75%,transparent)] bg-[length:50px_50px]"
  ...
  return (
    <section className="bg-[#EEEDEB] dark:bg-gray-900 flex justify-center items-center">
      ...
      <div className="w-full max-w-screen-xl px-4 py-8 mx-auto">
        <ProgressBar progress={50} duration={30} /> {/* Example values for progress and duration */}
      </div>
    </section>
  );
}
