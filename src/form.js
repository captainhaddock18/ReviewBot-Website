  ...
  return (
    <section class="bg-[#001D21] dark:bg-gray-900">
      <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-[#FB8569] dark:text-[#FB8569]">
          FeedBack
        </h2>
        <p class="mb-8 lg:mb-16 font-medium text-center text-[#FB8569] dark:text-[#FB8569] sm:text-xl">
        ...
        <form action="#" class="space-y-8">
          <div>
            <label
              for="email"
              class="block mb-2 text-sm font-medium text-[#FB8569] dark:text-[#FB8569]"
            >
              Your email
            </label>
            <input
